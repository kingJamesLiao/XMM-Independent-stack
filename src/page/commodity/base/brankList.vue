        ...
        <el-col :span="24">
          <div class="grid-content bg-purple step inp">
            <el-form ref="form" :model="sizeForm" label-width="100px" size="mini">
              <el-form-item class="commo" label="品牌名称" required>
              ...
              <el-form-item class="commo" label="排序">
                <div class="content border" style="width:120px;">
              ...
              <el-form-item class="commo" label="SEO描述">
                <div class="content">
                  <el-input
                    style="width:350px;"
                    type="textarea"
              ...
              <el-form-item class="commo" label="详情">
                <div class="content">
                  <el-input
                    style="width:350px;"
                    type="textarea"
