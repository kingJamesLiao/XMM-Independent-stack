<template>
  <div class="list">
    ...
    >
      ...
      <el-table-column label="图片" prop="src" width="120" align="center">
    ...
    <div class="batch">
      ...
      <el-button class="batchBtn" type="danger" @mouseover="this.show=true" @click="changeMask">批量操作</el-button>
      <el-button style="background:#7D7DC3;color:#fff; border:none;">批量修改分类商品</el-button>
      <!-- <el-button style="background:#7D7DC3;color:#fff;" @click="toggleSelection()">批量修改分类商品</el-button> -->
      <el-button style="background:#252535; color:#fff; border:none;">导入</el-button>
    </div>
    <div class="showBtn">
      <el-button v-show="isShow" class="btn1" @click="del">商品删除</el-button>
      <el-button v-show="isShow" class="btn2">修改商品</el-button>
    </div>
