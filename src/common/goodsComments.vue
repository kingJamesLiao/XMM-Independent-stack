<template>
  <div class="list">
    ...
    >
      ...
      <el-table-column prop="nation" label="国家" width="65">
        <template>
          <img src="../assets/style/image/china.png" style="width: 20px;height:20px;" />
        </template>
      </el-table-column>
      ...
      <el-table-column prop="tradeName" label="评论详情"></el-table-column>
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-dropdown
            ...
            split-button
            type="primary"
            @click="revert(scope.$index,tableData)"
          >
            回复
